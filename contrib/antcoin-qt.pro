...
RESOURCES += src/qt/antcoin.qrc src/qt/antcoin_locale.qrc
TRANSLATIONS += src/qt/locale/antcoin_bg.ts \
                src/qt/locale/antcoin_de.ts \
                src/qt/locale/antcoin_en.ts \
                src/qt/locale/antcoin_es.ts \
                src/qt/locale/antcoin_fi.ts \
                src/qt/locale/antcoin_fr.ts \
                src/qt/locale/antcoin_it.ts \
                src/qt/locale/antcoin_ja.ts \
                src/qt/locale/antcoin_pl.ts \
                src/qt/locale/antcoin_pt.ts \
                src/qt/locale/antcoin_ru.ts \
                src/qt/locale/antcoin_sk.ts \
                src/qt/locale/antcoin_sv.ts \
                src/qt/locale/antcoin_vi.ts \
                src/qt/locale/antcoin_zh_CN.ts \
                src/qt/locale/antcoin_zh_TW.ts
