...
Only requiring some minor changes is antcoin.cpp.
...
Changes to antcoin.cpp
----------------------
antcoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
