...
Antcoin Core version 0.12.0 is now available from:

  https://antcheck.io/downloads

Please report bugs using the issue tracker at github:

  https://github.com/antcheck/antcoin/issues
...
backwards-compatible with pre-0.12 versions of Antcoin Core or other software:
...
As well as everyone that helped translating on [Transifex](https://www.transifex.com/projects/p/antcoin/).
