...
/* *** BEGIN DARKSEND MAGIC - ANTCOIN **********
    Copyright (c) 2014-2015, Antcoin Developers
        eduffield - evan@antcheck.io
        udjinm6   - udjinm6@antcheck.io
*/
    ...
    if(fMasterNode) {
        ...
        BOOST_FOREACH(const CTransaction& txCollateral, vecSessionCollateral) {
            ...
            /*
                ...
                allow endless transaction that would bloat Antcoin and make it unusable. To
