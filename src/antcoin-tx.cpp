...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Antcoin Core antcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  antcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded antcoin transaction") + "\n" +
              "  antcoin-tx [options] -create [commands]   " + _("Create hex-encoded antcoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded antcoin transaction
