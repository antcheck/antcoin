    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Antcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Antcoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and antcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Antcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Antcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Antcoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Antcoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Antcoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a antcoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Antcoin Core help message to get a list with possible Antcoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Antcoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Antcoin network", "", count));
}
...
{
    QString strTitle = tr("Antcoin Core"); // default title
