    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Antcoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (about)
    {
        setWindowTitle(tr("About Antcoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  antcoin-qt [" + tr("command-line options") + "]                     " + "\n";
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Antcoin Core is shutting down...") + "<br /><br />" +
