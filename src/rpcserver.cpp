...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "Antcoin server stopping";
}
...
{ //  category              name                      actor (function)         okSafeMode threadSafe reqWallet
  //  --------------------- ------------------------  -----------------------  ---------- ---------- ---------
    ...
    /* Antcoin features */
    { "antcoin",               "masternode",             &masternode,             true,      true,       false },
    { "antcoin",               "masternodelist",         &masternodelist,         true,      true,       false },
    { "antcoin",               "mnbudget",               &mnbudget,               true,      true,       false },
    { "antcoin",               "mnbudgetvoteraw",        &mnbudgetvoteraw,        true,      true,       false },
    { "antcoin",               "mnfinalbudget",          &mnfinalbudget,          true,      true,       false },
    { "antcoin",               "mnsync",                 &mnsync,                 true,      true,       false },
    { "antcoin",               "spork",                  &spork,                  true,      true,       false },
#ifdef ENABLE_WALLET
    { "antcoin",               "darksend",               &darksend,               false,     false,      true  }, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
         ...
         (mapArgs["-rpcuser"] == mapArgs["-rpcpassword"])) && Params().RequireRPCPassword())
    {
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
            _("To use antcoind, or the -server option to antcoin-qt, you must set an rpcpassword in the configuration file:\n"
              "%s\n"
...
std::string HelpExampleCli(string methodname, string args){
    return "> antcoin-cli " + methodname + " " + args + "\n";
}
